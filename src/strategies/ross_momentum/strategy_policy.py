...
POLICY_V2 = StrategyPolicyV2(
    ...
    trigger_model=TriggerModelV2(
        ...
        confirmations=(
            ...
            ConfirmationSpecV2("K_VOLUME_CONFIRM", "Lightweight volume confirmation for fast-trigger eligibility; must not block first valid entry."),
            ...
            ConfirmationSpecV2("K_BREAK_AND_HOLD_CONFIRM", "Break-and-hold is optional for fast triggers and can tune sizing rather than entry eligibility."),
...
# Legacy compatibility surface retained for existing scanner/orchestrator consumers.
...
class StockSelectionSpec:
    ...
    session_watchlist_rvol_min: dict[str, float] = field(
        default_factory=lambda: {
            "PRE": 0.5,
            "RTH_OPEN": 1.5,
            "RTH_MID": 1.0,
