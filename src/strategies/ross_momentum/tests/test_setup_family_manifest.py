...
def _inputs(setup_id: str, positive: bool) -> PatternInputs:
    ...
    positive_map = {
        ...
        'BULL_FLAG': replace(base, candles=_candles([(10,10.4,9.98,10.35,1000),(10.35,10.8,10.3,10.75,1300),(10.75,11.0,10.72,10.95,1500),(10.95,10.98,10.82,10.9,800),(10.9,10.94,10.8,10.86,780),(10.86,10.9,10.79,10.84,760),(10.84,10.92,10.8,10.88,770),(10.86,10.89,10.8,10.83,740),(10.9,11.05,10.88,11.02,1400)]), indicators=IndicatorSet(ema9=10.9, ema20=10.8, vwap=10.85)),
        ...
        'CUP_HANDLE': replace(base, session_context=SessionContext.REGULAR, candles=_candles([(10.0,10.60,9.98,10.50,1000),(10.50,10.62,10.40,10.56,980),(10.56,10.64,10.50,10.60,970),(10.60,10.63,10.52,10.58,960),(10.58,10.60,10.20,10.35,900),(10.35,10.42,10.05,10.15,850),(10.15,10.30,10.00,10.10,820),(10.10,10.36,10.05,10.28,840),(10.28,10.45,10.20,10.38,860),(10.38,10.50,10.32,10.45,900),(10.45,10.58,10.40,10.55,930),(10.55,10.62,10.50,10.60,960),(10.60,10.61,10.54,10.56,700),(10.56,10.63,10.52,10.61,900)])),
        ...
        'OPENING_DRIVE': replace(base, session_context=SessionContext.REGULAR, session_phase='RTH_OPEN', candles=_candles([(10,10.1,9.98,10.05,900),(10.05,10.12,10.0,10.08,900),(10.08,10.18,10.05,10.16,910),(10.16,10.25,10.12,10.22,920),(10.22,10.35,10.2,10.32,1100)])),
        ...
        'FLAT_TOP_BREAKOUT': replace(base, candles=_candles([(10,10.18,10.10,10.15,800),(10.15,10.19,10.11,10.16,820),(10.16,10.18,10.12,10.15,840),(10.15,10.19,10.12,10.16,860),(10.16,10.26,10.15,10.25,1100)])),
        ...
        'HOD_BREAK': replace(base, session_context=SessionContext.REGULAR, candles=_candles([(10.0,10.2,9.98,10.12,800),(10.12,10.45,10.10,10.40,900),(10.40,10.80,10.74,10.76,1000),(10.76,10.88,10.75,10.84,950),(10.84,10.90,10.80,10.86,900),(10.86,10.92,10.84,10.90,1400)]), levels=LevelSet(premarket_high=10.5, hod=10.92, hod_source='RTH', prior_close=9.8), indicators=IndicatorSet(ema9=10.70, ema20=10.55, vwap=10.60)),
        'EMA_PULLBACK': replace(base, candles=_candles([(10,10.1,9.98,10.02,800),(10.02,10.18,10.0,10.16,850),(10.16,10.32,10.14,10.30,900),(10.30,10.34,10.18,10.22,760),(10.22,10.28,10.12,10.18,720),(10.18,10.36,10.16,10.34,1100)]), indicators=IndicatorSet(ema9=10.24, ema20=10.16, vwap=10.18, ema9_prev=10.20, ema20_prev=10.13)),
