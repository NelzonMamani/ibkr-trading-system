"""Range Bound Fade strategy adapter."""
...
class RangeBoundFadeStrategy(BaseStrategy):
    ...
    def process_watchlist(self, *, watchlist: List[object], snapshots: dict, session_label: str, timestamp_utc: str, mode: RunMode, session_phase: str) -> List[TradeIntent]:
        ...
        return [
            TradeIntent(
                ...
                rationale="Range-bound fade proxy identified controlled mean-reversion opportunity.",
    ...
    def _qualifies(self, *, symbol: str, timestamp_utc: str, session_phase: str) -> bool:
        del session_phase
        range_score = self._score(f"range-fade:{symbol}:{timestamp_utc}", scale=10_000)
