...
POLICY_V2 = StrategyPolicyV2(
    identity=StrategyIdentityV2(name="VOLATILITY_CONTRACTION_BREAKOUT", strategy_id="P13"),
    selection_plan=ScannerPlan(
        ...
        focus_limit_m=5,
        policy_name="VOLATILITY_CONTRACTION_BREAKOUT",
        gating_profile="VOLATILITY_CONTRACTION_BREAKOUT",
    ...
    intrabar_execution=IntrabarExecutionModelV2(
        phase_specs=(
            IntrabarPhaseSpecV2("INTRABAR_POLICY", "Intrabar Doctrine", "APPLICABLE", "Intrabar controls are explicitly declared."),
        ),
        timeframe_map=(
            IntrabarTimeframeMapV2(
                "INTRABAR_POLICY",
                ("5MIN", "1MIN"),
                ("5MIN", "1MIN"),
                ("10SEC", "1MIN") if "APPLICABLE" == "APPLICABLE" else ("1MIN", "5MIN"),
                "Intrabar exits may override candle close." if "APPLICABLE" == "APPLICABLE" else "NOT_APPLICABLE for intrabar override; candle-close authority only.",
            ),
        ),
