...
POLICY_V2 = StrategyPolicyV2(
    identity=StrategyIdentityV2(name="SUPPORT_RESISTANCE_CHANNEL", strategy_id="P10"),
    selection_plan=ScannerPlan(
        ...
        focus_limit_m=5,
        policy_name="SUPPORT_RESISTANCE_CHANNEL",
        gating_profile="SUPPORT_RESISTANCE_CHANNEL",
