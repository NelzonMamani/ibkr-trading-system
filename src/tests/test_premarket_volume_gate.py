...
def test_premarket_volume_gate_enforced() -> None:
    thresholds = GateThresholds(
        ...
        min_premarket_volume_threshold=5_000,
...
def test_premarket_rvol_override_allows_early_momentum() -> None:
    thresholds = GateThresholds(
        min_price=1.0,
        max_price=20.0,
        min_pct_change=3.0,
...
def test_rth_rvol_gate_unchanged_without_override() -> None:
    thresholds = GateThresholds(
        min_price=1.0,
        max_price=20.0,
        min_pct_change=3.0,
