...
CONFIG_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "LIVE_MICRO_MAX_CONCURRENT_TRADES": {
        "type": int,
        "default": 5,
        "env": ["LIVE_MICRO_MAX_CONCURRENT_TRADES", "LIVE_MICRO_MAX_POSITIONS"],
        "affects": ["ExecutionEngine", "CoreOrchestrator"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Max concurrent trades allowed in LIVE_MICRO.",
    },
    "PAPER_MAX_CONCURRENT_TRADES": {
        "type": int,
        "default": 5,
        "env": ["PAPER_MAX_CONCURRENT_TRADES"],
        "affects": ["ExecutionEngine", "CoreOrchestrator"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Max concurrent trades allowed in PAPER.",
    },
    ...
    "LIVE_MICRO_DAILY_MAX_LOSS": {
        "type": float,
        "default": 10.0,
        "env": ["LIVE_MICRO_DAILY_MAX_LOSS", "LIVE_MICRO_MAX_DAILY_LOSS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "HARD",
        "mutable": "dynamic",
    ...
    "LIVE_MICRO_ACK": {
        ...
        "default": False,
        "env": ["LIVE_MICRO_ACK"],
        "affects": ["CoreOrchestrator", "IbkrLiveBroker"],
        "enforcement": "HARD",
        "mutable": "static",
        "description": "Explicit operator acknowledgement required for LIVE_MICRO.",
    },
    "LIVE_MICRO_1_SHARE_ONLY": {
        "type": bool,
        "default": True,
        "env": ["LIVE_MICRO_1_SHARE_ONLY"],
        "affects": ["IbkrLiveBroker", "RiskEngine"],
        "enforcement": "HARD",
        "mutable": "static",
        "description": "Enforce 1-share limit in LIVE_MICRO.",
    },
    ...
    "LIVE_MICRO_MAX_CONSECUTIVE_LOSSES": {
        "type": int,
        "default": 1,
        "env": ["LIVE_MICRO_MAX_CONSECUTIVE_LOSSES"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "HARD",
        "mutable": "dynamic",
