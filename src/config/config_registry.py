...
CONFIG_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "PAPER_VALIDATION_SIZING_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["PAPER_VALIDATION_SIZING_ENABLED"],
        "affects": ["ExecutionRouter", "CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable paper validation sizing caps for micro-size execution safety.",
    },
    "PAPER_VALIDATION_MAX_SHARES": {
        "type": int,
        "default": 0,
        "env": ["PAPER_VALIDATION_MAX_SHARES"],
        "affects": ["ExecutionRouter"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Hard cap for shares per PAPER validation order (0 disables).",
    },
    "PAPER_VALIDATION_MAX_NOTIONAL": {
        "type": float,
        "default": 0.0,
        "env": ["PAPER_VALIDATION_MAX_NOTIONAL"],
        "affects": ["ExecutionRouter"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Hard cap for notional per PAPER validation order (0 disables).",
    },
    "PAPER_VALIDATION_FORCE_SINGLE_SHARE": {
        "type": bool,
        "default": False,
        "env": ["PAPER_VALIDATION_FORCE_SINGLE_SHARE"],
        "affects": ["ExecutionRouter"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Force 1-share PAPER validation orders when enabled.",
    },
