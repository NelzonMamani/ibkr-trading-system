...
CONFIG_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "RUN_MODE": {
        ...
        "choices": ["READ_ONLY", "PAPER", "LIVE", "SIM"],
        "normalizer": "run_mode",
    },
    "RUN_MODE_EFFECTIVE": {
        "type": str,
        ...
        "enforcement": "HARD",
        "mutable": "static",
        "description": "Derived run mode after safety rules (READ_ONLY override).",
        "choices": ["READ_ONLY", "PAPER", "LIVE", "SIM"],
        "normalizer": "upper",
        "derived": True,
    },
    ...
    "FORCE_EXECUTION_ON_TRADE_READY": {
        "type": bool,
        "default": True,
        "env": ["FORCE_EXECUTION_ON_TRADE_READY"],
        "affects": ["CoreOrchestrator", "ExecutionEngine"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Temporary debug enforcement to force execution routing for TRADE_READY intents when execution is enabled.",
    },
    "FORCE_RISK_APPROVAL_FOR_TRADE_READY": {
        "type": bool,
        "default": True,
        "env": ["FORCE_RISK_APPROVAL_FOR_TRADE_READY"],
        "affects": ["CoreOrchestrator", "RiskEngine"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
    ...
    "FORCE_CLEAN_START": {
        "type": bool,
        "default": False,
        "env": ["FORCE_CLEAN_START"],
        "affects": ["CoreOrchestrator", "IBKR"],
        "enforcement": "HARD",
        "mutable": "static",
        "description": "When true, cancel all broker open orders and flatten all broker positions before trading starts.",
    },
    "CLEAN_START_TIMEOUT_SECONDS": {
        "type": int,
        "default": 120,
        "env": ["CLEAN_START_TIMEOUT_SECONDS"],
        "affects": ["CoreOrchestrator", "IBKR"],
        "enforcement": "HARD",
        "mutable": "static",
    ...
    "PREMARKET_MIN_VOLUME": {
        "type": int,
        "default": 2_000,
        "env": ["PREMARKET_MIN_VOLUME"],
        "affects": ["RossMomentum"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Session-aware minimum volume threshold for PRE session contract checks.",
    },
    "RTH_MIN_VOLUME": {
        "type": int,
        "default": 10_000,
        ...
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Session-aware minimum volume threshold for regular session contract checks.",
    },
    ...
    "LIVE_EXECUTION_PROBE_MODE": {
        "type": bool,
        "default": True,
        "env": ["LIVE_EXECUTION_PROBE_MODE"],
        "affects": ["StrategyRunner", "ExecutionEngine"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable forced live execution probe mode for broker validation.",
    },
    "PROBE_SYMBOLS": {
        "type": list,
        "item_type": str,
        "default": ["UGRO"],
        "env": ["PROBE_SYMBOLS"],
        "affects": ["StrategyRunner"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Comma-separated symbols used by live execution probe mode.",
        "normalizer": "upper",
    },
    "PROBE_ORDER_SIZE": {
        "type": int,
        "default": 1,
        "env": ["PROBE_ORDER_SIZE"],
        "affects": ["ExecutionEngine", "RiskEngine"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Order size for each probe symbol when probe mode is enabled.",
    },
    "PROBE_HOLD_SECONDS": {
        "type": int,
        "default": 60,
        "env": ["PROBE_HOLD_SECONDS"],
        "affects": ["ExecutionEngine"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Hold duration in seconds before probe exit order is sent.",
    },
    "IBKR_KILL_SWITCH": {
        "type": bool,
        "default": True,
    ...
    "DAILY_RISK_GOVERNOR_ENABLED": {
        "type": bool,
        "default": True,
        "env": ["DAILY_RISK_GOVERNOR_ENABLED"],
        "affects": ["DailyRiskGovernor", "CoreOrchestrator", "ExecutionEngine"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Enable the P10 account-level daily risk governor.",
    },
    "DAILY_RISK_TIMEZONE": {
        "type": str,
        "default": "America/New_York",
        "env": ["DAILY_RISK_TIMEZONE"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Trading timezone used for daily risk reset boundaries.",
    },
    "DAILY_RISK_MAX_LOSS_AMOUNT": {
        "type": float,
        "default": 10.0,
        "env": ["DAILY_RISK_MAX_LOSS_AMOUNT"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Hard realized daily loss amount before new entries are blocked.",
    },
    "DAILY_RISK_MAX_LOSS_PCT": {
        "type": float,
        "default": 0.0,
        "env": ["DAILY_RISK_MAX_LOSS_PCT"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Hard realized daily loss percentage of account equity; zero disables this limit.",
    },
    "DAILY_RISK_MAX_DRAWDOWN_AMOUNT": {
        "type": float,
        "default": 0.0,
        "env": ["DAILY_RISK_MAX_DRAWDOWN_AMOUNT"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Hard daily drawdown amount before new entries are blocked; zero disables this limit.",
    },
    "DAILY_RISK_MAX_DRAWDOWN_PCT": {
        "type": float,
        "default": 0.0,
        "env": ["DAILY_RISK_MAX_DRAWDOWN_PCT"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Hard daily drawdown percentage of account equity; zero disables this limit.",
    },
    "DAILY_RISK_INCLUDE_UNREALIZED": {
        "type": bool,
        "default": False,
        "env": ["DAILY_RISK_INCLUDE_UNREALIZED"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Include unrealized losses in P10 daily loss and drawdown evaluation.",
    },
    "DAILY_RISK_MAX_TRADES": {
        "type": int,
        "default": 0,
        "env": ["DAILY_RISK_MAX_TRADES"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Maximum closed trades per trading day; zero disables this limit.",
    },
    "DAILY_RISK_MAX_LOSING_TRADES": {
        "type": int,
        "default": 0,
        "env": ["DAILY_RISK_MAX_LOSING_TRADES"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Maximum losing trades per trading day; zero disables this limit.",
    },
    "DAILY_RISK_MAX_CONSECUTIVE_LOSSES": {
        "type": int,
        "default": 0,
        "env": ["DAILY_RISK_MAX_CONSECUTIVE_LOSSES"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Maximum consecutive losing trades per trading day; zero disables this limit.",
    },
    "DAILY_RISK_EXISTING_POSITION_POLICY": {
        "type": str,
        "default": "MANAGED_ONLY",
        "env": ["DAILY_RISK_EXISTING_POSITION_POLICY"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "choices": ["MANAGED_ONLY", "FLATTEN", "HOLD"],
        "normalizer": "upper",
        "description": "Existing-position policy once P10 locks new entries.",
    },
    "DAILY_RISK_LIVE_FAIL_CLOSED": {
        "type": bool,
        "default": True,
        "env": ["DAILY_RISK_LIVE_FAIL_CLOSED"],
        "affects": ["DailyRiskGovernor", "ExecutionEngine"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Fail closed in LIVE when daily risk state cannot be reconstructed.",
    },
    "DAILY_RISK_MANUAL_HALT": {
        "type": bool,
        "default": False,
        "env": ["DAILY_RISK_MANUAL_HALT"],
        "affects": ["DailyRiskGovernor", "CoreOrchestrator", "ExecutionEngine"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Manual P10 emergency daily trading halt.",
    },
    "DAILY_RISK_RESET_TIME_LOCAL": {
        "type": str,
        "default": "00:00",
        "env": ["DAILY_RISK_RESET_TIME_LOCAL"],
        "affects": ["DailyRiskGovernor"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Local reset time in DAILY_RISK_TIMEZONE using HH:MM format.",
    },
    # =========================
    # Scanner controls
    # =========================
    ...
    "TOPN_REFRESH_SECONDS": {
        "type": int,
        "default": 300,
        "env": ["TOPN_REFRESH_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Per-strategy Top-N scanner refresh cadence in seconds.",
    },
    "WATCHLIST_REFRESH_SECONDS": {
        "type": int,
        "default": 60,
        "env": ["WATCHLIST_REFRESH_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Per-strategy watchlist rebuild cadence in seconds.",
    },
    "FOCUS_REFRESH_SECONDS": {
        "type": int,
        "default": 10,
        "env": ["FOCUS_REFRESH_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
    ...
    "PREP_REFRESH_CLOSED_MIN_SECONDS": {
        "type": int,
        "default": 7200,
        "env": ["PREP_REFRESH_CLOSED_MIN_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Minimum scheduled premarket prep refresh during CLOSED/weekend session.",
    },
    "PREP_REFRESH_CLOSED_MAX_SECONDS": {
        "type": int,
        "default": 21600,
        "env": ["PREP_REFRESH_CLOSED_MAX_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Maximum scheduled premarket prep refresh during CLOSED/weekend session.",
    },
    "PREP_REFRESH_PRE_MIN_SECONDS": {
        "type": int,
        "default": 900,
        "env": ["PREP_REFRESH_PRE_MIN_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Minimum scheduled premarket prep refresh during PRE session.",
    },
    "PREP_REFRESH_PRE_MAX_SECONDS": {
        "type": int,
        "default": 1800,
        "env": ["PREP_REFRESH_PRE_MAX_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Maximum scheduled premarket prep refresh during PRE session.",
    },
    "PREP_REFRESH_REG_MIN_SECONDS": {
        "type": int,
        "default": 1800,
        "env": ["PREP_REFRESH_REG_MIN_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Minimum scheduled premarket prep refresh during regular session.",
    },
    "PREP_REFRESH_REG_MAX_SECONDS": {
        "type": int,
        "default": 3600,
        "env": ["PREP_REFRESH_REG_MAX_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Maximum scheduled premarket prep refresh during regular session.",
    },
    "PREP_REFRESH_AH_MIN_SECONDS": {
        "type": int,
        "default": 3600,
        "env": ["PREP_REFRESH_AH_MIN_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Minimum scheduled premarket prep refresh during after-hours session.",
    },
    "PREP_REFRESH_AH_MAX_SECONDS": {
        "type": int,
        "default": 10800,
        "env": ["PREP_REFRESH_AH_MAX_SECONDS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Maximum scheduled premarket prep refresh during after-hours session.",
    },
    "POSITION_MANAGEMENT_TICK_SECONDS": {
        "type": int,
        "default": 1,
        "env": ["POSITION_MANAGEMENT_TICK_SECONDS"],
        "affects": ["CoreOrchestrator", "TradeExitEngine"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Open-position management loop cadence in seconds.",
    },
    "FOCUS_MAX_SYMBOLS_PER_STRATEGY": {
        "type": int,
        "default": 5,
        "env": ["FOCUS_MAX_SYMBOLS_PER_STRATEGY"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Per-strategy focus cache size cap.",
    },
    "WATCHLIST_MAX_SYMBOLS_PER_STRATEGY": {
        "type": int,
        "default": 15,
        "env": ["WATCHLIST_MAX_SYMBOLS_PER_STRATEGY"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Per-strategy watchlist cache size cap.",
    },
    "TOPN_MAX_SYMBOLS_PER_STRATEGY": {
        "type": int,
        "default": 50,
        "env": ["TOPN_MAX_SYMBOLS_PER_STRATEGY"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Per-strategy top-N cache size cap.",
    },
    ...
    "SCANNER_FLOAT_CACHE_FILE": {
        "type": str,
        "default": "data/reference/float_cache.json",
    ...
    "ROSS_PCT_CHANGE_MIN": {
        "type": float,
        "default": 3.0,
        "env": ["ROSS_PCT_CHANGE_MIN"],
        "affects": ["ScannerFilters", "RossMomentum"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Temporary live-debug override for minimum pct_change gate.",
    },
    "ROSS_RVOL_MIN": {
        "type": float,
        "default": 0.5,
        ...
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Temporary live-debug override for minimum watchlist RVOL gate.",
    },
    "WATCHLIST_RVOL_MIN": {
        "type": float,
        "default": None,
        "allow_none": True,
        "env": ["WATCHLIST_RVOL_MIN"],
        "affects": ["ScannerFilters", "RossMomentum"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Optional runtime override for minimum RVOL required to keep a symbol in WATCHLIST_K.",
    },
    "FOCUS_RVOL_MIN": {
        "type": float,
        "default": None,
    ...
    "MAX_SPREAD_PCT": {
        ...
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Optional runtime override for max spread percentage gate.",
    },
    "ALLOW_UNKNOWN_FLOAT": {
        "type": bool,
        "default": True,
    ...
    "STRATEGY_CAPITAL_ALLOCATIONS": {
        "type": dict,
        "default": {},
        "env": ["STRATEGY_CAPITAL_ALLOCATIONS"],
        "affects": ["StrategyCapitalAllocationAuthority", "ExecutionEngine"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Per-strategy capital allocation limits enforced before P7 capital admission.",
    },
    "STRATEGY_CAPITAL_DEFAULT_ALLOCATION_PCT": {
        "type": float,
        "default": 0.50,
        "env": ["STRATEGY_CAPITAL_DEFAULT_ALLOCATION_PCT"],
        "affects": ["StrategyCapitalAllocationAuthority", "ExecutionEngine"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Default fraction of available account capital assigned to one strategy when no explicit allocation is configured.",
    },
    ...
    "RISK_MAX_OPEN_POSITIONS": {
        ...
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Max concurrent open positions allowed by RiskEngine.",
    },
    "RISK_MAX_TOTAL_EXPOSURE_PCT": {
        ...
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Max total exposure as % of equity allowed by RiskEngine.",
    },
    "LIFECYCLE_MAX_PORTFOLIO_EXPOSURE": {
        "type": float,
        "default": 5000.0,
        "env": ["MAX_PORTFOLIO_EXPOSURE"],
        "affects": ["RiskEngine"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Lifecycle-enforced hard cap for total portfolio exposure.",
    },
    "LIFECYCLE_MAX_POSITION_EXPOSURE": {
        "type": float,
        "default": 1500.0,
        "env": ["MAX_POSITION_EXPOSURE"],
        "affects": ["RiskEngine"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Lifecycle-enforced hard cap for single position exposure.",
    },
    "LIFECYCLE_MAX_POSITIONS": {
        ...
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Lifecycle-enforced max number of open positions.",
    },
    "LIFECYCLE_MANUAL_KILL_SWITCH": {
        "type": bool,
        "default": False,
        "env": ["LIFECYCLE_MANUAL_KILL_SWITCH"],
        "affects": ["RiskEngine"],
        "enforcement": "HARD",
        "mutable": "dynamic",
    ...
    "E22_STRATEGY_SCALABILITY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["E22_STRATEGY_SCALABILITY_ENABLED"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "HARD",
        "mutable": "static",
        "description": "Enable E22 strategy scalability/arbitration layer.",
    },
    "E22_MAX_STRATEGIES_PER_CYCLE": {
        "type": int,
        "default": 20,
        "env": ["E22_MAX_STRATEGIES_PER_CYCLE"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "static",
        "description": "E22 cap for number of strategies scheduled per cycle.",
    },
    "E22_MAX_INTENTS_PER_CYCLE": {
        "type": int,
        "default": 200,
        "env": ["E22_MAX_INTENTS_PER_CYCLE"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "static",
        "description": "E22 global cap for intents retained after arbitration.",
    },
    "E22_MAX_POSITIONS_PER_CYCLE": {
        "type": int,
        "default": 50,
        "env": ["E22_MAX_POSITIONS_PER_CYCLE"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "static",
        "description": "E22 cap for distinct symbols allowed per cycle.",
    },
    "E22_SYMBOL_EXCLUSIVITY": {
        "type": bool,
        "default": True,
        "env": ["E22_SYMBOL_EXCLUSIVITY"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "static",
        "description": "E22 symbol exclusivity conflict policy.",
    },
    "E22_STRATEGY_PRIORITY": {
        "type": dict,
        "default": {},
        "env": ["E22_STRATEGY_PRIORITY"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "static",
        "description": "Optional E22 strategy priority map (strategy->priority).",
    },
    "E22_STRATEGY_MAX_INTENTS": {
        "type": dict,
        "default": {},
        "env": ["E22_STRATEGY_MAX_INTENTS"],
        "affects": ["CoreOrchestrator"],
        "enforcement": "SOFT",
        "mutable": "static",
        "description": "Optional E22 per-strategy intent cap map (strategy->max_intents).",
    },
    "SELECTED_STRATEGY": {
        "type": str,
        "default": "",
    ...
    "ENABLED_STRATEGIES": {
        ...
        "default": {
            ...
            "CrossSectionalRelativeStrengthRotationStrategy": False,
            "TimeBasedSeasonalityStrategy": False,
            "TrendFollowingClassicStrategy": False,
            "LongHorizonQualityCompounderStrategy": False,
            "RegimeAdaptiveMetaAllocatorStrategy": False,
            "OpeningDriveStrategy": False,
            "VwapReclaimStrategy": False,
            "PowerHourStrategy": False,
            "VolatilityExpansionStrategy": False,
            "RangeBoundFadeStrategy": False,
            "SupportResistanceChannelStrategy": False,
        },
        "env": [],
        "affects": ["Strategies"],
        "enforcement": "ADVISORY",
