...
CONFIG_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "MIN_ABSOLUTE_VOLUME": {
        "type": int,
        "default": 50_000,
        "env": ["MIN_ABSOLUTE_VOLUME"],
        "affects": ["ScannerFilters", "RossMomentum"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Hard tradeability gate for minimum absolute volume before strategy evaluation.",
    },
    "MIN_LIQUIDITY_SCORE": {
        "type": float,
        "default": 0.1,
        "env": ["MIN_LIQUIDITY_SCORE"],
        "affects": ["ScannerFilters", "RossMomentum"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Hard tradeability gate for minimum liquidity score.",
    },
    "ENABLE_OVN_TRADING": {
        "type": bool,
        "default": False,
        "env": ["ENABLE_OVN_TRADING"],
        "affects": ["ScannerFilters", "RossMomentum"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Allow overnight symbols to pass tradeability gates.",
    },
    "ENABLE_RVOL_IN_OVN": {
        "type": bool,
        "default": False,
        "env": ["ENABLE_RVOL_IN_OVN"],
        "affects": ["ScannerFilters", "RossMomentum"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Enable RVOL gating during overnight session.",
    },
    "MIN_PREMARKET_VOLUME": {
        "type": int,
        "default": 50_000,
        "env": ["MIN_PREMARKET_VOLUME"],
        "affects": ["ScannerFilters", "RossMomentum"],
        "enforcement": "HARD",
        "mutable": "dynamic",
        "description": "Minimum premarket volume threshold for tradeability.",
    },
    "ROSS_REQUIRE_NEWS": {
        "type": bool,
        "default": True,
