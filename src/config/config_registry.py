...
CONFIG_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "OPENING_DRIVE_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["OPENING_DRIVE_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Opening Drive strategy execution.",
    },
    "VWAP_RECLAIM_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["VWAP_RECLAIM_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable VWAP Reclaim strategy execution.",
    },
    "POWER_HOUR_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["POWER_HOUR_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Power Hour strategy execution.",
    },
    "VOLATILITY_EXPANSION_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["VOLATILITY_EXPANSION_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Volatility Expansion strategy execution.",
    },
    "RANGE_BOUND_FADE_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["RANGE_BOUND_FADE_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Range Bound Fade strategy execution.",
    },
    "SUPPORT_RESISTANCE_CHANNEL_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["SUPPORT_RESISTANCE_CHANNEL_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Support/Resistance Channel strategy execution.",
    },
    "EVENT_EARNINGS_REACTION_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["EVENT_EARNINGS_REACTION_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Event Earnings Reaction strategy execution.",
    },
    "EVENT_NEWS_SHOCK_CONTINUATION_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["EVENT_NEWS_SHOCK_CONTINUATION_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Event News Shock Continuation strategy execution.",
    },
    "VOLATILITY_CONTRACTION_BREAKOUT_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["VOLATILITY_CONTRACTION_BREAKOUT_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Volatility Contraction Breakout strategy execution.",
    },
    "VOLATILITY_CARRY_RISK_PREMIUM_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["VOLATILITY_CARRY_RISK_PREMIUM_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Volatility Carry Risk Premium strategy execution.",
    },
    "PAIRS_DIVERGENCE_REVERSION_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["PAIRS_DIVERGENCE_REVERSION_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Pairs Divergence Reversion strategy execution.",
    },
    "CROSS_SECTIONAL_RELATIVE_STRENGTH_ROTATION_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["CROSS_SECTIONAL_RELATIVE_STRENGTH_ROTATION_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Cross Sectional Relative Strength Rotation strategy execution.",
    },
    "TIME_BASED_SEASONALITY_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["TIME_BASED_SEASONALITY_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Time Based Seasonality strategy execution.",
    },
    "TREND_FOLLOWING_CLASSIC_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["TREND_FOLLOWING_CLASSIC_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Trend Following Classic strategy execution.",
    },
    "LONG_HORIZON_QUALITY_COMPOUNDER_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["LONG_HORIZON_QUALITY_COMPOUNDER_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Long Horizon Quality Compounder strategy execution.",
    },
    "REGIME_ADAPTIVE_META_ALLOCATOR_STRATEGY_ENABLED": {
        "type": bool,
        "default": False,
        "env": ["REGIME_ADAPTIVE_META_ALLOCATOR_STRATEGY_ENABLED"],
        "affects": ["Strategies"],
        "enforcement": "SOFT",
        "mutable": "dynamic",
        "description": "Enable Regime Adaptive Meta Allocator strategy execution.",
    },
