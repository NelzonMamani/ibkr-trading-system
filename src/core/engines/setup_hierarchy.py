...
_SUPPRESSION_RULES: dict[str, set[str]] = {
    ...
    "HOD_BREAK": {"MICRO_PULLBACK", "BULL_FLAG", "THREE_BAR_PULLBACK"},
    "FIRST_PULLBACK": {"MICRO_PULLBACK", "BULL_FLAG"},
    "ABCD": {"BULL_FLAG", "RANGE"},
    "CUP_HANDLE": {"MICRO_PULLBACK", "THREE_BAR_PULLBACK"},
    "PARABOLIC_EXHAUSTION": {"MICRO_PULLBACK", "FIRST_PULLBACK", "BULL_FLAG", "ABCD", "CUP_HANDLE"},
}

_TIER_RANK = {
    "PARABOLIC_EXHAUSTION": 1,
    "GAP_GO": 1,
    "OPENING_DRIVE": 1,
