...
class DecisionEngine:
    ...
    _COMPATIBILITY_MATRIX: dict[str, set[str]] = {
        "GAP_GO": {"P_GAP_GO", "P_PREMKT_BREAK", "P_PREMARKET_HIGH_BREAK", "P_ORB", "P_HOD_BREAK", "P_FIRST_PULLBACK"},
        ...
        "PREMARKET_HIGH_BREAK": {"P_PREMKT_BREAK", "P_PREMARKET_HIGH_BREAK", "P_HOD_BREAK"},
        "HOD_BREAK": {"P_HOD_BREAK", "P_PREMKT_BREAK", "P_PREMARKET_HIGH_BREAK", "P_RANGE_BREAKOUT"},
        ...
        "VWAP_RECLAIM_CONTINUATION": {"P_VWAP_PULLBACK", "P_MOMENTUM_RECLAIM", "P_FIRST_PULLBACK", "P_MICRO_PULLBACK"},
        "VWAP_PULLBACK": {"P_VWAP_PULLBACK", "P_MOMENTUM_RECLAIM", "P_FIRST_PULLBACK", "P_MICRO_PULLBACK"},
        "THREE_BAR_PULLBACK": {"P_THREE_BAR_PULLBACK"},
        "SECOND_PULLBACK": {"P_SECOND_PULLBACK"},
