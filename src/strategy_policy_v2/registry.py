...
_POLICY_IMPORT_PATHS: dict[str, str] = {
    ...
    "mean_reversion": "src.strategies.mean_reversion.strategy_policy_v2.POLICY_V2",
...
_RESOLVERS: dict[str, Callable[[], StrategyPolicyV2]] = {
    ...
    "mean_reversion": lambda: __import__(
        "src.strategies.mean_reversion.strategy_policy_v2",
        fromlist=["POLICY_V2"],
    ).POLICY_V2,
}
