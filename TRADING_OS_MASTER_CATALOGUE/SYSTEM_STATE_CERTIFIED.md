...
- P02_STATISTICAL_INTRADAY_MOMENTUM: PARTIAL
- P03_MEAN_REVERSION: PARTIAL
- P04_LONG_HORIZON_VALUE: PARTIAL
- P05_OPENING_DRIVE: PARTIAL
- P06_VWAP_RECLAIM: PARTIAL
- P07_POWER_HOUR: PARTIAL
- P08_VOLATILITY_EXPANSION: PARTIAL
- P09_RANGE_BOUND_FADE: PARTIAL
- P10_SUPPORT_RESISTANCE_CHANNEL: PARTIAL
- P11_EVENT_EARNINGS_REACTION: PARTIAL
- P12_EVENT_NEWS_SHOCK_CONTINUATION: PARTIAL
- P13_VOLATILITY_CONTRACTION_BREAKOUT: PARTIAL
- P14_VOLATILITY_CARRY_RISK_PREMIUM: PARTIAL
- P15_PAIRS_DIVERGENCE_REVERSION: PARTIAL
- P16_CROSS_SECTIONAL_RELATIVE_STRENGTH_ROTATION: PARTIAL
- P17_TIME_BASED_SEASONALITY: PARTIAL
- P18_TREND_FOLLOWING_CLASSIC: PARTIAL
- P19_LONG_HORIZON_QUALITY_COMPOUNDER: PARTIAL
- P20_REGIME_ADAPTIVE_META_ALLOCATOR: PARTIAL
