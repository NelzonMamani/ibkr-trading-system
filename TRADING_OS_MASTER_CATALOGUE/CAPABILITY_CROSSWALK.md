...
| E8 Regime & Microstructure | Regime layer | `src/regime/`, `tests/test_regime_classifier.py`, `tests/test_regime_observers.py`, `tests/test_regime_policy_application.py`, `tests/test_regime_live_readonly_missingness.py`, `TRADING_OS_MASTER_CATALOGUE/AUDIT_EVIDENCE/EPOCH_08/` | PARTIAL |
| E9 Performance Analytics | Performance registry | `src/core/performance_registry.py`, `tests/test_performance_registry_epoch9.py`, `TRADING_OS_MASTER_CATALOGUE/AUDIT_EVIDENCE/EPOCH_09/EPOCH_09_E9_PERFORMANCE_ANALYTICS.md` | PARTIAL |
| E10 Capital Allocation | Allocation arbitration | `src/strategy_portfolio/allocation.py`, `tests/strategy_portfolio/test_allocation.py`, `tests/strategy_portfolio/test_arbitration.py`, `TRADING_OS_MASTER_CATALOGUE/AUDIT_EVIDENCE/EPOCH_10/EPOCH_10_E10_CAPITAL_ALLOCATION.md` | PARTIAL |
| E11 Learning System | Learning pipeline | `src/learning/`, `TRADING_OS_MASTER_CATALOGUE/AUDIT_EVIDENCE/EPOCH_11/EPOCH_11_E11_LEARNING_SYSTEM.md` | PARTIAL |
| E12 Recovery & Housekeeping | Storage + stop control | `src/storage/`, `src/core/stop_controller.py`, `TRADING_OS_MASTER_CATALOGUE/AUDIT_EVIDENCE/EPOCH_12/EPOCH_12_E12_RECOVERY_AND_HOUSEKEEPING.md` | PARTIAL |
| E13 Strategy Factory Standard | Registry + base | `src/strategies/strategy_registry.py`, `src/strategies/strategy_base.py`, `tests/test_strategy_registry_epoch13.py`, `TRADING_OS_MASTER_CATALOGUE/AUDIT_EVIDENCE/EPOCH_13/EPOCH_13_E13_STRATEGY_FACTORY_STANDARD.md` | PARTIAL |
| E14 Decision Artifacts | Intent + signal models | `src/core/intent.py`, `src/models/data_models.py`, `src/execution/execution_engine.py`, `TRADING_OS_MASTER_CATALOGUE/AUDIT_EVIDENCE/EPOCH_14/EPOCH_14_E14_DECISION_ARTIFACTS.md` | PARTIAL |
