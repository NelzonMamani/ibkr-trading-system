# P12_EVENT_NEWS_SHOCK_CONTINUATION — ALGORITHM (Exhaustive, Certification-Grade)
**Timestamp:** 2026-02-08T01:28:21Z  
**Strategy ID:** P12_EVENT_NEWS_SHOCK_CONTINUATION  
**Intent:** News shock continuation: catalyst-driven momentum with risk controls.  
...
### Setup Families
**ALLOWED:** SF_NEWS_SPIKE, SF_EVENT_CONTINUATION, SF_HALT_RESUME, SF_RANGE_EXPANSION, SF_HIGH_OF_DAY_BREAK  
**DENIED:** SF_MEAN_REVERSION_EXTENSION, SF_LONG_TERM_ACCUMULATION  
...
**ALLOWED:** 08_XL_RANGE_BREAK, 07_XL_HOD_BREAK, 10_XL_MEASURED_MOVE  
