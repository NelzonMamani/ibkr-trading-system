# P06_VWAP_RECLAIM — ALGORITHM (Exhaustive, Certification-Grade)
**Timestamp:** 2026-02-08T01:28:21Z  
**Strategy ID:** P06_VWAP_RECLAIM  
**Intent:** Intraday reclaim of VWAP/anchored VWAP after flush; continuation or mean-shift.  
...
### Setup Families
**ALLOWED:** SF_VWAP_RECLAIM, SF_KEY_LEVEL_RECLAIM, SF_LIQUIDITY_SWEEP, SF_STOP_RUN_REVERSAL  
**DENIED:** SF_GAP_AND_GO, SF_OPENING_RANGE_BREAKOUT, SF_LONG_TERM_ACCUMULATION  
