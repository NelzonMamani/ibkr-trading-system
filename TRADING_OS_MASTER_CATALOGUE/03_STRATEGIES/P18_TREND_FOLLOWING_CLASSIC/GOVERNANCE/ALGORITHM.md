# P18_TREND_FOLLOWING_CLASSIC — ALGORITHM (Exhaustive, Certification-Grade)
**Timestamp:** 2026-02-08T01:28:21Z  
**Strategy ID:** P18_TREND_FOLLOWING_CLASSIC  
**Intent:** Classic trend following (daily/weekly) with pullbacks, breakouts, trailing.  
...
### Setup Families
**ALLOWED:** SF_DAILY_TREND_PULLBACK, SF_WEEKLY_BASE_BREAKOUT, SF_RANGE_EXPANSION, SF_KEY_LEVEL_RECLAIM  
**DENIED:** SF_VWAP_FADE, SF_MEAN_REVERSION_EXTENSION  
...
**ALLOWED:** 06_XL_EMA_RECLAIM, 08_XL_RANGE_BREAK, 10_XL_MEASURED_MOVE  
