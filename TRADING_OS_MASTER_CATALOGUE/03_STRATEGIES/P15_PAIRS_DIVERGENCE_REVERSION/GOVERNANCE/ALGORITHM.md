# P15_PAIRS_DIVERGENCE_REVERSION — ALGORITHM (Exhaustive, Certification-Grade)
**Timestamp:** 2026-02-08T01:28:21Z  
**Strategy ID:** P15_PAIRS_DIVERGENCE_REVERSION  
**Intent:** Pairs divergence mean reversion with spread z-scores; hedged intents.  
...
### Setup Families
**ALLOWED:** SF_PAIR_DIVERGENCE, SF_SPREAD_REVERSION, SF_ZSCORE_EXTREME, SF_MEAN_REVERSION_SEQUENCE  
**DENIED:** SF_GAP_AND_GO, SF_OPENING_RANGE_BREAKOUT, SF_HALT_RESUME  
