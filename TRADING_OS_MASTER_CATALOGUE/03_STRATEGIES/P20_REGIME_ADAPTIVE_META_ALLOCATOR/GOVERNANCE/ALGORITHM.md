# P20_REGIME_ADAPTIVE_META_ALLOCATOR — ALGORITHM (Exhaustive, Certification-Grade)
**Timestamp:** 2026-02-08T01:28:21Z  
**Strategy ID:** P20_REGIME_ADAPTIVE_META_ALLOCATOR  
**Intent:** Meta allocator selecting among strategies/allocations by regime.  
...
### Setup Families
**ALLOWED:** SF_HIGH_VOLATILITY_REGIME, SF_LOW_VOLATILITY_REGIME, SF_HIGH_VOLATILITY_REGIME, SF_MACRO_REGIME_SHIFT  
**DENIED:**   
...
**ALLOWED:** None (allocator/emits allocation intents only)  
