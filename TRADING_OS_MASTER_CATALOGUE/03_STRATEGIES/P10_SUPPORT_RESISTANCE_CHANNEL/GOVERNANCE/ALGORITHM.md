# P10_SUPPORT_RESISTANCE_CHANNEL — ALGORITHM (Exhaustive, Certification-Grade)
**Timestamp:** 2026-02-08T01:28:21Z  
**Strategy ID:** P10_SUPPORT_RESISTANCE_CHANNEL  
**Intent:** S/R channel trading: breaks, reclaims, and mean inside channel.  
...
### Setup Families
**ALLOWED:** SF_WEEKLY_LEVEL_INTERACTION, SF_KEY_LEVEL_BREAK, SF_KEY_LEVEL_RECLAIM, SF_BOX_RANGE, SF_RANGE_EXPANSION  
**DENIED:** SF_HALT_RESUME, SF_EVENT_REVERSAL, SF_LONG_TERM_ACCUMULATION  
...
**ALLOWED:** 08_XL_RANGE_BREAK, 06_XL_EMA_RECLAIM, 05_XL_VWAP_RECLAIM, 10_XL_MEASURED_MOVE  
